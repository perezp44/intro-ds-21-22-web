...
**Calendario de clases** y HOMEWORK: iré actualizándo este apartado conforme pasen las semanas. Aquí os dejaré las **tareas previas a cada clase**. Tenemos 14 sesiones. Intenta faltar lo menos posible y asiste, sí o sí, a las 4 primeras sesiones. Intentaré ajustar y acertar lo más posible con la programación de las clases pero ... , como sabéis, en una clase siempre puede haber incidentes/sorpresas. 
</div>
